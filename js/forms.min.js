...
for(var o=0;o<r.items.length;o+=1)!function(o,i){var s=!1
...
if(m.addEventListener("click",f,!1),c.className="form-input-descriptor",c.innerHTML=o,c.addEventListener("click",function(){"radio"===t?(m.checked=!0,f()):"checkbox"===t&&(m.checked=!m.checked,f())},!1),l.appendChild(m),l.appendChild(c),!0===s){var u=a.createElement("div"),d=a.createElement("div")
...
var t
if("cols"===r.answerBy)for(t=0;t<r.cols.length;t+=1)n._pageRequirements[n._pages-1][e].requirements.push(r.cols[t].name)
...
"radio"===t?"cols"===r.answerBy?i[o]=a:i[a]=o:"checkbox"===t&&("cols"===r.answerBy?(i[o]=i[o]||[],!0===n.checked?i[o].push(a):(i[o].splice(i[o].indexOf(a),1),0===i[o].length&&delete i[o])):(i[a]=i[a]||[],!0===n.checked?i[a].push(o):(i[a].splice(i[a].indexOf(o),1),0===i[a].length&&delete i[a])))},l=0;l<r.rows.length;l+=1){var m=o.createElement("tr"),c=o.createElement("th")
c.innerHTML=r.rows[l].title||"",m.appendChild(c)
for(var p=0;p<r.cols.length;p+=1){var f=o.createElement("td"),u=o.createElement("input")
u.setAttribute("type",t),u.setAttribute("row",r.rows[l].name||""),u.setAttribute("col",r.cols[p].name||""),"rows"===r.answerBy?u.setAttribute("name",r.rows[l].name||""):u.setAttribute("name",r.cols[p].name||""),u.addEventListener("click",s,!1),f.appendChild(u),m.appendChild(f)}e.appendChild(m)}},__basic_component:function(e,t){t._pageRequirements[t._pages-1].push(e.name)
var r=document,n=r.createElement("div"),a=r.createElement("h3"),o=r.createElement("p")
return n.className="form-"+e.type+" form-container",a.className="form-title",o.className="form-subtitle",a.innerHTML=e.title||"",o.innerHTML=e.subtitle||"",n.appendChild(a),n.appendChild(o),"plainText"===e.type&&(e.name="_",e.optional=!0),n.setAttribute("form-name",e.name),!0===e.hasOwnProperty("validations")&&n.setAttribute("form-validations",JSON.stringify(e.validations)),!0===e.hasOwnProperty("optional")&&n.setAttribute("form-optional",Boolean(e.optional)),n},input:function(e,t){var r=document,n=this.__basic_component(e,t),a=r.createElement("div"),o=r.createElement("input"),i=r.createElement("div")
...
for(var o=0;o<t.length;o+=1)o!=e?t[o].classList.add("form-hidden"):t[o].classList.remove("form-hidden")},Form.prototype.pageComplete=function(){var e=this,t=e._currentPage,r=document,n=function(t,a,o){for(var i,s,l=!0,m=0;m<t.length;m+=1){if(i=!0,"string"==typeof t[m]){if(""===(s=t[m]))continue
!1===a.hasOwnProperty(t[m])?i=!1:!1===Boolean(a[t[m]])&&(i=!1)}else{if(""===(s=t[m].name))continue
i=n(t[m].requirements,a[t[m].name],o+1)}if(0===o&&"string"==typeof t[m]){var c=r.querySelector('[form-name="'+s+'"]')
if(null!=c){var p=c.getAttribute("form-validations"),f=!!c.getAttribute("form-optional")
if(null!=p)if(p=JSON.parse(p),!1===i)i=f
else for(var u=0;u<p.length&&!0===i;u+=1)!1===e.validate(p[u],a[t[m]])&&(i=!1)
